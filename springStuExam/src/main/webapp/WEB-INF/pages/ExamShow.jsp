...
<body>
	<div align="center">
		...
		<table border="4" bgcolor="orange">
			<tr>
			<th  style="color:pink">ExamID</th>
			<th  style="color:pink">Subject Name</th>
			<th  style="color:pink">Marks</th>
			<th  style="color:pink">Action</th>
			</tr>
			...
			<c:set var="sid" value="${exam.sid}"/>	
				<tr>
					...
					<td>${exam.subName}</td>
					<td>${exam.marks}</td>
					<td><a href="editExam?mi=${exam.mi}">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
