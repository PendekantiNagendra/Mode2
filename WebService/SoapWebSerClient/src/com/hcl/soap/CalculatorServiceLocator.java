...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.hcl.soap.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.17:8086/SoapWebSerDemo/services/Calculator";
    ...
    public com.hcl.soap.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.soap.CalculatorSoapBindingStub _stub = new com.hcl.soap.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.soap.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.soap.CalculatorSoapBindingStub _stub = new com.hcl.soap.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap.hcl.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap.hcl.com", "Calculator"));
        }
