...
public class HelloProxy implements com.hcl.helloservice.endpoint.Hello {
  private String _endpoint = null;
  private com.hcl.helloservice.endpoint.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new com.hcl.helloservice.endpoint.HelloServiceLocator()).getHelloPort();
      if (hello != null) {
        if (_endpoint != null)
  ...
  public com.hcl.helloservice.endpoint.Hello getHello() {
    if (hello == null)
      _initHelloProxy();
    return hello;
  }
